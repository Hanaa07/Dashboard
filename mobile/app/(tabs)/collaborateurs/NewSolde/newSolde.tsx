...
export default function NewScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Text style={styles.title}>Ajout d'un solde pour John Doe</Text>
            <ScrollView>
                <Text style={styles.textTitle}>Date de début</Text>
                <TextInput placeholder="Date de début" style={styles.text}/>
                <Text style={styles.textTitle}>Date de fin</Text>
                <TextInput placeholder="Date de fin" style={styles.text}/>
                <Text style={styles.textTitle}>Solde</Text>
                <TextInput placeholder="Solde" style={styles.text}/>
                <Text style={styles.textTitle}>jours restants du solde</Text>
                <TextInput placeholder="jours restants du solde" style={styles.text}/>
