...
export default function NewScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Text style={styles.title}>Modification du solde de John Doe</Text>
            <ScrollView>
                ...
                <TextInput placeholder="01/06/2023" style={styles.text}/>
                ...
                <TextInput placeholder="5" style={styles.text}/>
